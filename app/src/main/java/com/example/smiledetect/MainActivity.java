package com.example.smiledetect;
...
public class MainActivity extends AppCompatActivity implements FrameProcessor {
    ...
    private void detectFaces(List<FirebaseVisionFace> firebaseVisionFaces, Bitmap bitmap) {
        ...
        for (int i = 0; i < firebaseVisionFaces.size(); i++) {
            ...
            faceDetectionModels.add(new FaceDetectionModel(i, "Smiling Probability " + face.getSmilingProbability()*100+"%"));
            faceDetectionModels.add(new FaceDetectionModel(i, "Left Eye Open Probability " + face.getLeftEyeOpenProbability()*100+"%"));
            faceDetectionModels.add(new FaceDetectionModel(i, "Right Eye Open Probability " + face.getRightEyeOpenProbability()*100+"%"));
